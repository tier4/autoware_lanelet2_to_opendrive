...
from ..centerline import Width1DSplineAdapter, estimate_lanelet_width_as_spline
...
class Lane:
    ...
    def construct_from_lanelet(
        ...
        # Width calculation: each lane's width is the lanelet's own width
        # (left boundary to right boundary), not cumulative from reference line
        ...
        # Calculate width as lanelet's own width (left boundary to right boundary)
