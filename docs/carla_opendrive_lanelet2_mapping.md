...
| [JunctionParser](#junctionparser) | [`junction/controller@id`](https://publications.pages.asam.net/standards/ASAM_OpenDRIVE/ASAM_OpenDRIVE_Specification/v1.8.1/specification/12_junctions/12.6_junction_groups.html) | Controller ID, Traffic signal reference | [`JunctionParser.cpp` L17-L50](https://github.com/carla-simulator/carla/blob/master/LibCarla/source/carla/opendrive/parser/JunctionParser.cpp#L17-L50) | Enhancement required | ❌ | Lanelet2 has controller concept but needs mapping | Links junction to traffic signal controller | [TrafficLightStage.cpp L45-75](https://github.com/carla-simulator/carla/blob/master/LibCarla/source/carla/trafficmanager/TrafficLightStage.cpp#L45-L75) |
| [JunctionParser](#junctionparser) | [`junction/controller@type`](https://publications.pages.asam.net/standards/ASAM_OpenDRIVE/ASAM_OpenDRIVE_Specification/v1.8.1/specification/12_junctions/12.6_junction_groups.html) | Controller type, Controller classification | [`JunctionParser.cpp` L17-L50](https://github.com/carla-simulator/carla/blob/master/LibCarla/source/carla/opendrive/parser/JunctionParser.cpp#L17-L50) | Enhancement required | ❌ | Controller type classification | - | - |
