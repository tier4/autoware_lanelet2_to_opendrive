...
| [ObjectParser](#objectparser) | [`road/objects/object@zOffset`](https://publications.pages.asam.net/standards/ASAM_OpenDRIVE/ASAM_OpenDRIVE_Specification/latest/specification/13_objects/13_01_introduction.html) | Object Z offset, Vertical position above road | [`ObjectParser.cpp` L84](https://github.com/carla-simulator/carla/blob/master/LibCarla/source/carla/opendrive/parser/ObjectParser.cpp#L84) | Average elevation of left/right boundary points | ✅ | Mean of leftBound and rightBound Z coordinates | - | - |
