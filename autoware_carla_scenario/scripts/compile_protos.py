...
#: Upstream revision the vendored ``.proto`` files were copied from.
...
_ABSOLUTE_IMPORT = re.compile(r"^from alpasim_grpc\.v0 import ", flags=re.MULTILINE)

_HEADER = f"""\
# Generated by autoware_carla_scenario/scripts/compile_protos.py -- do not edit.
#
# Source: NVlabs/alpasim@{ALPASIM_REV} (Apache-2.0)
...
def _generate(destination: Path) -> None:
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        for path in sorted((raw / "alpasim_grpc" / "v0").iterdir()):
