...
if TYPE_CHECKING:
    from .actions import (
        ...
        RelativePositionAction as RelativePositionAction,
        SpeedAction as SpeedAction,
    ...
    from .conditions import (
        ...
        RelativePositionCondition as RelativePositionCondition,
        ScalarComparisonRule as ScalarComparisonRule,
        ScenarioResult as ScenarioResult,
        SequentialCondition as SequentialCondition,
...
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
    ...
    "RelativePositionAction": (".actions", "RelativePositionAction"),
    "SpeedAction": (".actions", "SpeedAction"),
    ...
    "RelativePositionCondition": (".conditions", "RelativePositionCondition"),
    "ScalarComparisonRule": (".conditions", "ScalarComparisonRule"),
    "ScenarioResult": (".conditions", "ScenarioResult"),
    "SequentialCondition": (".conditions", "SequentialCondition"),
